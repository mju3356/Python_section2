...
class Ncafe_Member_Exr:
    ...
    def Get_Member_List(self):
        ...
        time.sleep(3)
        #로그인완료
        self.driver.get('https://cafe.naver.com/CafeMemberViewTab.nhn?defaultSearch.clubid=23157428')
        self.driver.implicitly_wait(30)
        self.driver.switch_to_frame('cafe_main')
        soup=BeautifulSoup(self.driver.page_source,'html.parser')
        return soup.select('div.mem_list_wrap > ul > li > div > div.nick > div > table > tbody > tr > td > a > div')

    def Print_Member_List(self,list):
        f=open('c:/MP/Ncafe_Member_List.txt','wt')
        for a in list:
            f.write(a.string.strip()+'\n')
...
if __name__ == '__main__':
    ...
    a.Print_Member_List(a.Get_Member_List())
